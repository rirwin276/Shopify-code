(function(){
  ...
  function add(){
    ...
    if(document.querySelector('[data-ss-cc1717="1"]'))return true;
    var t=document.getElementById('peTable');
    if(!t)return false;
    var m=t.querySelector('input[data-module="LS14003_front_back"]')||t.querySelector('input[data-module="M2580_front_back"]');
